    ...
    while (true) {
        ...
        try {
            ...
            if (value >= min && value <= max) {
                ...
                System.out.printf("Invalid time. Please enter a number between %.1f and %.1f.%n", min, max);
            }
        } catch (NumberFormatException e) {
            System.out.println("Invalid value. Please enter a valid float time number.");
        }
    }
}
